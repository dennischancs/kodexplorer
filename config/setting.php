...
$config['settingSystemDefault'] = array(
	...
	'newUserApp'		=> "trello,AriaNg,一起写office,微信,365日历,石墨文档,ProcessOn,计算器,icloud,OfficeConverter",
...
$config['settingSystemDefault']['menu'] = array(
	...
	array('name'=>'AriaNg','type'=>'system','url'=>'/static/ariang/index.html','target'=>'_blank','use'=>'1')
);
